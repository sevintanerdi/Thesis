...
old = '''    result = {}
    ...
    for name, col in col_map.items():
        ...
        if p_diff < 0.05:
            # Clearly I(1): stationary after first difference
            result[name] = s
            ...
            # Borderline or unclear: keep in levels per supervisor guidance
            # (non-stationary series kept in levels to avoid over-differencing)
            result[name] = s
